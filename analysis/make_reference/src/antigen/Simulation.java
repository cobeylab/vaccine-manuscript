...
//		}
	...
	public void run() {
		...
		try {
			...
			hostOutStream.println("date\tvaccinated\tinfected\tlastVaccineDate\tlastLastVaccineDate\tvaccinationRate\tnVaccines\tnInfections");
...
//			}					
	...
	public void initReadDb() {
		try{
			File readDbFile = new File("refPhenotypes.sqlite");

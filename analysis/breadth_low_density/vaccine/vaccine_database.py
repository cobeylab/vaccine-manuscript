...
def loadJob(comboDb, resultsDir, runId, jobDir):
        try:
            ...
            if tmrcaLimit == 0 :
                ...
                meanTMRCA = float(pd.read_sql('SELECT value FROM summary WHERE key == "tmrca"', con=outDb)['value'][0])
...
if __name__ == "__main__":
    ...
    comboDb = sqlite3.connect(os.path.join(sweepDir, 'results_new.sqlite'))
